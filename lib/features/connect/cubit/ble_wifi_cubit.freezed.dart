...
mixin _$BleWifiState {
 ...
 BleWifiStatus get status; int get currentDeviceIndex; bool get isWifiConnected; String get hintText; List<BluetoothDevice> get devices;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BleWifiState&&(identical(other.status, status) || other.status == status)&&(identical(other.currentDeviceIndex, currentDeviceIndex) || other.currentDeviceIndex == currentDeviceIndex)&&(identical(other.isWifiConnected, isWifiConnected) || other.isWifiConnected == isWifiConnected)&&(identical(other.hintText, hintText) || other.hintText == hintText)&&const DeepCollectionEquality().equals(other.devices, devices));
}


@override
int get hashCode => Object.hash(runtimeType,status,currentDeviceIndex,isWifiConnected,hintText,const DeepCollectionEquality().hash(devices));

@override
String toString() {
  return 'BleWifiState(status: $status, currentDeviceIndex: $currentDeviceIndex, isWifiConnected: $isWifiConnected, hintText: $hintText, devices: $devices)';
}
...
@useResult
$Res call({
 BleWifiStatus status, int currentDeviceIndex, bool isWifiConnected, String hintText, List<BluetoothDevice> devices
});
...
/// Create a copy of BleWifiState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? status = null,Object? currentDeviceIndex = null,Object? isWifiConnected = null,Object? hintText = null,Object? devices = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( BleWifiStatus status,  int currentDeviceIndex,  bool isWifiConnected,  String hintText,  List<BluetoothDevice> devices)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BleWifiState() when $default != null:
return $default(_that.status,_that.currentDeviceIndex,_that.isWifiConnected,_that.hintText,_that.devices);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( BleWifiStatus status,  int currentDeviceIndex,  bool isWifiConnected,  String hintText,  List<BluetoothDevice> devices)  $default,) {final _that = this;
switch (_that) {
case _BleWifiState():
return $default(_that.status,_that.currentDeviceIndex,_that.isWifiConnected,_that.hintText,_that.devices);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( BleWifiStatus status,  int currentDeviceIndex,  bool isWifiConnected,  String hintText,  List<BluetoothDevice> devices)?  $default,) {final _that = this;
switch (_that) {
case _BleWifiState() when $default != null:
return $default(_that.status,_that.currentDeviceIndex,_that.isWifiConnected,_that.hintText,_that.devices);case _:
  return null;
...
class _BleWifiState implements BleWifiState {
  const _BleWifiState({required this.status, this.currentDeviceIndex = -1, this.isWifiConnected = false, this.hintText = '', final  List<BluetoothDevice> devices = const <BluetoothDevice>[]}): _devices = devices;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _BleWifiState&&(identical(other.status, status) || other.status == status)&&(identical(other.currentDeviceIndex, currentDeviceIndex) || other.currentDeviceIndex == currentDeviceIndex)&&(identical(other.isWifiConnected, isWifiConnected) || other.isWifiConnected == isWifiConnected)&&(identical(other.hintText, hintText) || other.hintText == hintText)&&const DeepCollectionEquality().equals(other._devices, _devices));
}


@override
int get hashCode => Object.hash(runtimeType,status,currentDeviceIndex,isWifiConnected,hintText,const DeepCollectionEquality().hash(_devices));
...
/// Create a copy of BleWifiState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? status = null,Object? currentDeviceIndex = null,Object? isWifiConnected = null,Object? hintText = null,Object? devices = null,}) {
