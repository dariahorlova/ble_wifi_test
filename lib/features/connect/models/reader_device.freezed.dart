...
mixin _$ReaderDevice {
 ...
 String? get readerId; ReaderConnection get connection; DeviceConfig? get config;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ReaderDevice&&(identical(other.readerId, readerId) || other.readerId == readerId)&&(identical(other.connection, connection) || other.connection == connection)&&(identical(other.config, config) || other.config == config));
}


@override
int get hashCode => Object.hash(runtimeType,readerId,connection,config);

@override
String toString() {
  return 'ReaderDevice(readerId: $readerId, connection: $connection, config: $config)';
}
...
@useResult
$Res call({
 String? readerId, ReaderConnection connection, DeviceConfig? config
});
...
/// Create a copy of ReaderDevice
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? readerId = freezed,Object? connection = null,Object? config = freezed,}) {
  return _then(_self.copyWith(
readerId: freezed == readerId ? _self.readerId : readerId // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? readerId,  ReaderConnection connection,  DeviceConfig? config)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ReaderDevice() when $default != null:
return $default(_that.readerId,_that.connection,_that.config);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? readerId,  ReaderConnection connection,  DeviceConfig? config)  $default,) {final _that = this;
switch (_that) {
case _ReaderDevice():
return $default(_that.readerId,_that.connection,_that.config);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? readerId,  ReaderConnection connection,  DeviceConfig? config)?  $default,) {final _that = this;
switch (_that) {
case _ReaderDevice() when $default != null:
return $default(_that.readerId,_that.connection,_that.config);case _:
  return null;
...
class _ReaderDevice implements ReaderDevice {
  const _ReaderDevice({this.readerId, this.connection = ReaderConnection.none, this.config});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ReaderDevice&&(identical(other.readerId, readerId) || other.readerId == readerId)&&(identical(other.connection, connection) || other.connection == connection)&&(identical(other.config, config) || other.config == config));
}
...
/// Create a copy of ReaderDevice
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? readerId = freezed,Object? connection = null,Object? config = freezed,}) {
